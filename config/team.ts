...
export const teamData: TeamMember[] = [
    {
        ...
        crefito: "123456-F", // Placeholder, will update if found
        image: "/gallery/fachada.jpg", // Using facade as placeholder since no profile pic provided yet, or maybe keep empty
