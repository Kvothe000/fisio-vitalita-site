        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
            ...
            <div className="space-y-8">
              {/* Telefone */}
              <div className="flex items-start space-x-4 p-6 bg-purple-50 dark:bg-slate-800 rounded-2xl border border-purple-100 dark:border-slate-700 transition-all hover:shadow-md">
                <div className="bg-[#5B21B6] dark:bg-purple-700 p-3 rounded-full shrink-0">
                  <Phone className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Telefone / WhatsApp</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">{siteInfo.contact.phone}</p>
                  <a
                    href={`https://wa.me/${siteInfo.contact.waPhone}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#5B21B6] dark:text-purple-400 font-semibold hover:text-[#4c1d95] hover:underline inline-flex items-center"
                  >
                    Iniciar conversa
                  </a>
                </div>
              ...
              <div className="flex items-start space-x-4 p-6 bg-purple-50 dark:bg-slate-800 rounded-2xl border border-purple-100 dark:border-slate-700 transition-all hover:shadow-md">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Endereço</h3>
              ...
              <div className="flex items-start space-x-4 p-6 bg-purple-50 dark:bg-slate-800 rounded-2xl border border-purple-100 dark:border-slate-700 transition-all hover:shadow-md">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1">E-mail</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
            ...
            <div className="bg-white dark:bg-slate-800 p-8 md:p-10 rounded-3xl shadow-xl border border-gray-100 dark:border-slate-700 transition-colors">
              <ContactForm />
            </div>
