        ...
        <ul className="hidden md:flex space-x-6 items-center text-gray-700">
          <li>
            <Link 
              ...
              className={`hover:text-[#5B21B6] transition-colors ${
                pathname === '/sobre' ? 'text-[#5B21B6] font-semibold' : ''
              }`}
            >
              Sobre
            </Link>
            ...
            <div className="absolute top-full left-1/2 -translate-x-1/2 w-64 bg-white shadow-xl rounded-lg mt-2
              ...
              {servicesLinks.map((link) => (
                <Link 
                  ...
                  className={`text-gray-700 transition-colors flex items-center space-x-3 p-3 rounded-md font-medium ${
                    pathname === link.href ? 'bg-purple-50 text-[#5B21B6]' : 'hover:bg-gray-100 hover:text-[#5B21B6]'
                  }`}
                >
          ...
          <li>
            <Link 
              href="/equipe" 
              className={`hover:text-[#5B21B6] transition-colors ${
                pathname === '/equipe' ? 'text-[#5B21B6] font-semibold' : ''
              }`}
            >
              Equipe
            </Link>
          ...
          <li>
            <Link 
              href="/estrutura" 
              className={`hover:text-[#5B21B6] transition-colors ${
                pathname === '/estrutura' ? 'text-[#5B21B6] font-semibold' : ''
              }`}
            >
              Estrutura
            </Link>
          ...
          <li>
            <Link 
              href="/contato" 
              className={`hover:text-[#5B21B6] transition-colors ${
                pathname === '/contato' ? 'text-[#5B21B6] font-semibold' : ''
              }`}
            >
              Contato
            </Link>
        ...
        <ul className="flex flex-col p-4 space-y-2">
          <li>
            <Link 
              ...
              className={`block p-3 rounded-md font-medium transition-colors ${
                pathname === '/sobre' ? 'bg-purple-50 text-[#5B21B6]' : 'hover:bg-gray-100'
              }`}
            >
              Sobre
            </Link>
          ...
          <li className="pl-4 border-l-2 border-gray-200 ml-1 space-y-1"> 
            {servicesLinks.map((link) => (
              <Link 
                ...
                href={link.href}
                onClick={() => setIsMobileMenuOpen(false)}
                className={`text-gray-700 transition-colors flex items-center space-x-3 p-2 rounded-md ${
                  pathname === link.href ? 'bg-purple-50 text-[#5B21B6] font-semibold' : 'hover:bg-gray-50 hover:text-[#5B21B6]'
                }`}
              >
          ...
          <li>
            <Link 
              ...
              onClick={() => setIsMobileMenuOpen(false)}
              className={`block p-3 rounded-md font-medium transition-colors ${
                pathname === '/equipe' ? 'bg-purple-50 text-[#5B21B6]' : 'hover:bg-gray-100'
              }`}
            >
              Equipe
            </Link>
          ...
          <li>
            <Link 
              ...
              onClick={() => setIsMobileMenuOpen(false)}
              className={`block p-3 rounded-md font-medium transition-colors ${
                pathname === '/estrutura' ? 'bg-purple-50 text-[#5B21B6]' : 'hover:bg-gray-100'
              }`}
            >
              Estrutura
            </Link>
          ...
          <li>
            <Link 
              ...
              onClick={() => setIsMobileMenuOpen(false)}
              className={`block p-3 rounded-md font-medium transition-colors ${
                pathname === '/contato' ? 'bg-purple-50 text-[#5B21B6]' : 'hover:bg-gray-100'
              }`}
            >
              Contato
            </Link>
